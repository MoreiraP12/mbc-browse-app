...
import { ArrowRight, FileText, Database, Search, BarChart2, Layers, Book, Users, Settings, CheckCircle, Globe, Clock, Building, TrendingUp, Calendar, Key, AlertCircle, Bot, MessageSquare } from 'lucide-react';

const MedBrowseCompHops = () => {
  return (
    <div className="w-full bg-white p-6 rounded-xl">
      <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">MedBrowseComp Research Questions</h2>
      
      <div className="flex flex-row gap-6">
        {/* Agent Questions Section */}
        <div className="w-1/3 flex flex-col gap-6">
          <div className="rounded-lg p-5 shadow-md bg-green-50 border-2 border-green-500 text-gray-800 h-full">
            ...
            <div className="mt-6">
              ...
              <div className="bg-white p-3 rounded border border-green-200">
                ...
                <img src="lenalidomide.png" alt="Lenalidomide treatment data from HemOnc.org" className="w-full rounded border border-gray-200" />
              </div>
            </div>
        ...
        <div className="w-2/3 flex flex-col gap-8">
          ...
          {/* Question 1 - Clinical Trial Ingredient */}
          <div className="flex flex-row items-center">
            <div className="w-full">
              <div className="rounded-lg p-5 shadow-md bg-blue-50 border-2 border-blue-500 text-gray-800">
                <div className="flex items-center mb-3">
                  <Clock className="w-6 h-6 text-blue-600 mr-3" />
                  <h3 className="font-bold text-xl text-blue-800">Question 1: Clinical Trial Ingredient</h3>
                </div>
          ...
          <div className="flex flex-row items-center">
            <div className="w-full">
              <div className="rounded-lg p-5 shadow-md bg-blue-100 border-2 border-blue-600 text-gray-800">
                <div className="flex items-center mb-3">
                  <Building className="w-6 h-6 text-blue-600 mr-3" />
                  <h3 className="font-bold text-xl text-blue-800">Question 2: Company with Latest FDA Approval</h3>
                </div>
          ...
          <div className="flex flex-row items-center">
            <div className="w-full">
              <div className="rounded-lg p-5 shadow-md bg-blue-200 border-2 border-blue-700 text-gray-800">
                <div className="flex items-center mb-3">
                  <Calendar className="w-6 h-6 text-blue-600 mr-3" />
                  <h3 className="font-bold text-xl text-blue-800">Question 3: Patent Expiration Date</h3>
                </div>
          ...
          <div className="flex flex-row items-center">
            <div className="w-full">
              <div className="rounded-lg p-5 shadow-md bg-blue-300 border-2 border-blue-800 text-gray-800">
                <div className="flex items-center mb-3">
                  <Key className="w-6 h-6 text-blue-600 mr-3" />
                  <h3 className="font-bold text-xl text-blue-800">Question 4: FDA Exclusivity Date</h3>
                </div>
          ...
          <div className="flex flex-row items-center">
            <div className="w-full">
              <div className="rounded-lg p-5 shadow-md bg-blue-400 border-2 border-blue-900 text-gray-800">
                <div className="flex items-center mb-3">
                  <TrendingUp className="w-6 h-6 text-blue-600 mr-3" />
                  <h3 className="font-bold text-xl text-blue-800">Question 5: Stock Market Data</h3>
                </div>
            ...
            <div className="flex items-center justify-center w-16">
              {/* Empty space to maintain alignment with other hops */}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 border-t-2 border-gray-200 pt-6">
        ...
        <div className="grid grid-cols-5 gap-2">
          <div className="rounded-lg p-3 shadow-md flex flex-col items-center justify-center text-center bg-gray-50 border border-gray-300">
